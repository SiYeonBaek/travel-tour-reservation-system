	...
	<head>
		...
		<script type="text/javascript">
			function send(f){
				...
				var fileinfo1 = f.fileinfo1.value;
...
<body style="width:1800px; margin:0 auto;">
	...
	<div class="main">
		<div class="content">
			<div class="product">
				<h1>여행 상품 추가</h1>
				<form enctype="multipart/form-data" method="post" action="addproduct_insert.do">
					<div class="product_all">
						<div class="product_content">
							<div class="product_add">
								<div class="add">
									...
									<input type="text" id="pname" name="pname" class="form_add">
								</div>
								<div class="add">
									<div class="add1">
										<label>상품 가격 : </label>
									</div>
									<input type="text" id="pprice" name="pprice" class="form_add">
								</div>
								<div class="add">
									<div class="add1">
										<label>도착지 : </label>
									</div>
									<input type="text" id="pcountry" name="pcountry" class="form_add">
								</div>
								<div class="add">
									<div  class="add1">
										<label>여행 기간 : </label>
									</div>
									<input type="text" id="pperiod" name="pperiod" class="form_add">
								</div>
								<div class="add">
									<div  class="add1">
										<label>상품 예약 상태 : </label>
									</div>
									<input type="text" id="pcheck" name="pcheck" class="form_add">
								</div>
								<div class="add">
									<div  class="add1">
										<label>항공편 : </label>
									</div>
									<input type="text" id="pair" name="pair" class="form_add">
								</div>
								<div class="add">
									<div  class="add1">
										<label>출/도착일 : </label> 
									</div>
									<input type="text" id="pmove" name="pmove" class="form_add">
								</div>
								<div class="add">
									<div  class="add1">
										<label>여행 일정표 : </label>
									</div>
									<input type="text" id="pschedule" name="pschedule" class="form_add">
								</div>
								<div class="add">
									<div  class="add1">
										<label>호텔 정보 : </label>
									</div>
									<input type="text" id="photel" name="photel" class="form_add">
								</div>
								<div class="add">
									<div class="add1">
										<label>예약 총 인원 : </label>
									</div>
									<input type="text" id="ptotcount" name="ptotcount" class="form_add">
								</div>
								<div class="add">
									<div class="add1">
										<label>예약 인원 : </label>
									</div>
									<input type="text" id="prescount" name="prescount" class="form_add">
								</div>
								<div class="add">
									<div class="add1">
										<label>여유 좌석 : </label>
								...
								<div class="add">
									...
									<input type="text" id="pdibc"name="pdibc" class="form_add">
								</div>
								<div class="add">
									<div class="add1">
										<label>상품 상세설명 : </label>
									</div>
									<textarea rows="10" cols="50" id="paccount" name="paccount" class="form_add"></textarea>
								</div>
							</div>
						...
						<div class="product_button">
							<div class="btn_mg">
								<div class="btn_add">
									<input type="button" class="btn_lf" value="상품추가" onclick="send(this.form)">
