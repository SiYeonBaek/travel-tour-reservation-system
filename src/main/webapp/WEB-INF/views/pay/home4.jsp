...
<script>
	        ...
	        function requestPay() { //인자 값으로 컨트롤러로부터 받아온 차량명 데이터를 삽입하였다.
...
<body style="margin: 0; padding: 0;">
	<div style="width: 1100px; margin: 0 auto;">
		...
		<div
			style="border: 1px solid green; height: 50px; overflow: auto; line-height: 50px;">
			<span>${vo.pname}</span>
		</div>
		...
		<div style="overflow: auto; border: 1px solid red; s margin: 0">
			...
			<div style="display: flex; margin: 0; overflow: auto;">
				<div style="border: 1px solid blue; float: left; width: 50%;">

					<div style="margin: 0; height: 250px; overflow: hidden;">
						<div
							style="border: 1px solid gold; width: 100%; height: 50%; overflow: hidden;">


							<div
								style="display: flex; margin: 0; height: 127px; overflow: hidden;">
								<div
									style="border: 1px solid gold; float: left; width: 33%; height: 100%; line-height: 127px; text-align: center;">
									총 금액</div>


								<div
									style="border: 1px solid gold; float: left; width: 66%; height: 100%; line-height: 127px; text-align: center;">
									<c:set var="row_sum1"
										value="${param.oadultcount*Price.oadultPrice}" />
									<c:set var="row_sum2"
										value="${param.okidscount*Price.okidsPrice}" />
									<c:set var="row_sum3"
										value="${param.ochildcount*Price.ochildPrice}" />
									<c:out value="${row_sum1+row_sum2+row_sum3}" />
						...
						<div style="border: 1px solid gold; width: 100%; height: 50%">
							<div
								style="display: flex; margin: 0; height: 127px; overflow: hidden;">
								<div
									style="border: 1px solid gold; float: left; width: 33%; height: 100%; line-height: 127px; text-align: center;">
									인원별 금액</div>
								<div
									style="border: 1px solid gold; float: left; width: 33%; height: 100%;">
									<span>성인</span>${param.oadultcount*Price.oadultPrice} <br>
									<span>아동</span>${param.okidscount*Price.okidsPrice} <br> <span>유아</span>${param.ochildcount*Price.ochildPrice}
									<br>
				...
				<div
					style="border: 1px solid pink; float: left; width: 50%; height: 250px;">
					<div>
					...
					<div>
						<h4>예약/결제 취소 관련</h4>
						<p>인터넷상에서 예약/결제 취소 및 변경은 불가능하오니, 예약/결제 취소나 여행자정보 변경을 원하시면 반드시
							예약담당자에게 연락해 주시기 바랍니다.</p>
					</div>
				</div>
		...
		<div
			style="overflow: auto; height: 100px; border: 1px solid yellow; overflow: hidden; margin: 0">


			<div style="display: flex; margin: 0;">
				<div
					style="border: 1px solid gold; float: left; width: 25%; height: 100px; text-align: center;">
					<span style="line-height: 100px;">여행 총 인원</span>
				</div>
				<div
					style="border: 1px solid gold; float: left; width: 25%; height: 100px; text-align: center;">
					<div style="height: 50%; border: 1px solid red; overflow: auto;">

						<span style="line-height: 50px;">성인 (만 12세 이상)</span>
					</div>
					<div style="height: 50%; border: 1px solid blue;">

						<span style="line-height: 50px;" id='result1'
							style="margin:0 10px;">${param.oadultcount} </span>
				...
				<div
					style="border: 1px solid red; float: left; width: 25%; height: 100px; text-align: center;">
					<div style="height: 50%; border: 1px solid red;">
						<span style="line-height: 50px;">아동 Extra Bed (만 12세 미만)</span>
					</div>
					<div style="height: 50%; border: 1px solid blue;">

						<span style="line-height: 50px;" id='result2'
							style="margin:0 10px;">${param.okidscount} </span>
				...
				<div
					style="border: 1px solid blue; float: left; width: 25%; height: 100px; text-align: center;">


					<div style="height: 50%; border: 1px solid red;">
						<span style="line-height: 50px;">유아 (만 2세 미만)</span>
					</div>
					<div style="height: 50%; border: 1px solid blue;">

						<span style="line-height: 50px;" id='result3'
							style="margin:0 10px;">${param.ochildcount} </span>
		...
		<div style="border: 1px solid green; height: 500px; overflow: auto;">
			<div style="border: 1px solid red; height:20%;">
			<span>대표 여행자</span>
			</div>
			<div style="border: 1px solid blue; height:20%;">
			<div style="line-height: 100px;">
			<span> </span><input style="width:260px;height:40px;" type="text" name="name" placeholder="한글이름">
			<input style="width:260px;height:40px;" type="text" name="name" placeholder="영문 성">
			<input style="width:260px;height:40px;" type="text" name="name" placeholder="영문 이름">
			</div>
			</div>
			
			<div style="border: 1px solid pink; height:20%;">
			<div style="line-height: 100px;">
			<span> </span><input style="width:260px;height:40px;" type="text" name="name" placeholder="한글이름">
			<input style="width:260px;height:40px;" type="text" name="name" placeholder="생년월일 8자리">
			<input style="width:260px;height:40px;" type="text" name="name" placeholder="영문 이름">
			</div>
		...
		<div style="border: 1px solid blue;">
			...
			<div>
				<input id="" type="checkbox" /> <input id="check-btn1"
					type="checkbox" /> <label for="check-btn1">국외여행표준약관동의</label>
				<ul class="menubars1">
					<div>
						<tr>
...
② 특수지역에의 여행으로서 정당한 사유가 있는 경우에는 이 표준약관의 내용과 달리 정할 수 있습니다.
			...
			<div>
				<input id="" type="checkbox" /> <input id="check-btn2"
					type="checkbox" /> <label for="check-btn2">해외여행 보험</label>
				<ul class="menubars2">
					<div>
						<tr>
							<td align=center><textarea name="tos" rows=15 cols=100
...
③ 회사가 청약을 승낙한 때에는 지체없이 보험가입증서(보험증권)를 계약자에게 교부하여 드리며, 청약을 거절할 경우에는 거절통지와 함께 받은 금액을 계약자에게 돌려드립니다.
...
제4조(회사의 보장의 시기 및 종기)
① 회사의 보장은 보험기간의 첫날 오후 4시에 시작하여 마지막날 오후 4시에 끝납니다. 그러나 보험가입증서(보험증권)에 이와 다른 시각이 기재되어 있을 때에는 그 시각으로 하며, 시각은 보험가입증서(보험증권) 발행지의 표준시를 따릅니다.
...
제5조(청약의 철회)
① 가계성보험(개인의 일상생활과 관련된 보험으로 보험료를 단체 또는 법인이 부담하지 않는 개인보험계약과 단체요율(피보험자가 단체인 계약에 적용되는 요율)이 적용되지 않는 계약을 말합니다)에 한하여 계약자는 청약을 한 날 또는 보험료를 납입한 날부터 15일 이내에 그 청약을 철회할 수 있습니다. 다만, 보험기간이 90일 이내인 경우에는 그러하지 아니합니다.
② 회사는 청약의 철회를 접수한 경우에는 지체없이 보험료를 돌려드리며, 보험료 반환이 지체된 기간에 대하여는 보험개발원이 공시하는 정기예금 이율로 계산한 금액을 더하여 지급합니다.
제6조(보상하는 손해)
① 회사는 피보험자가 보험가입증서(보험증권)에 기재된 여행을 목적으로 주거지를 출발하여 여행을 마치고 주거지에 도착할 때까지의 여행도중에 급격하고도 우연한 외래의 사고(이하 “사고”라 합니다)로 신체(의수, 의족, 의안, 의치 등 신체보조장구는 제외합니다)에 상해를 입었을 때에는 그 상해로 인하여 생긴 손해(이하 “손해”라 합니다)를 이 약관에 따라 보상하여 드립니다.
...
제8조(사망보험금)
① 회사는 피보험자가 제6조(보상하는 손해)에서 정한 사고로 상해를 입고 그 직접결과로써 사고일부터 1년 이내에 사망하였을 경우에는 보험가입금액 전액을 사망보험금으로 수익자(수익자의 지정이 없을 때에는 피보험자의 상속인)에게 지급합니다.
...
제10조(의료비보험금)
① 회사는 피보험자가 제6조(보상하는 손해)에서 정한 상해를 입고 그 직접결과로써 의사의 치료를 받은 때에는 1사고당 의료비가입금액을 한도로 피보험자가 실제로 부담한 의료비 전액을 지급합니다. 그러나 어떠한 경우에도 사고일부터 180일을 한도로 합니다.
...
<용어풀이>
다수계약에 해당하는 보험종목은 제3보험의 상해․질병․간병보험 및 손해보험의 종합․장기손해․개인 연금․
퇴직보험으로 합니다.
...
제12조(보험금의 지급한도)
① 회사가 지급하여야 할 사망 또는 후유장해보험금은 보험기간을 통하여 보험가입증서(보험증권)에 기재된 사망 또는 후유장해 보험가입금액 각각을 한도로 합니다.
...
제15조(계약의 해지)
① 계약자는 손해가 발생하기 전에는 언제든지 계약을 해지할 수 있습니다. 다만 타인을 위한 계약의 경우에는 계약자는 그 타인의 동의를 얻거나 보험가입증서(보험증권)를 소지한 경우에 한하여 계약을 해지할 수 있습니다.
...
제17조(계약의 무효)
타인의 사망을 보험사고로 하는 계약에서 계약을 체결할 때까지 피보험자의 서면에 의한 동의를 얻지 아니한 경우에는 계약을 무효로 합니다. 다만, 단체가 규약에 따라 구성원의 전부 또는 일부를 피보험자로 하는 계약을 체결하는 경우에는 이를 적용하지 아니합니다.
제18조(보험료의 환급)
...
제21조 (보험금의 지급)
① 회사는 제20조(보험금 청구시 구비서류)에서 정한 청구서류를 접수한 때에는 접수증을 교부하고 그 서류를 접수한 날로부터 신체손해에 관한 보험금은 3영업일, 배상책임손해에 대한 보험금은 10영업일, 재산손해에 대한 보험금은 20영업일 이내에 지급합니다.
...
제24조 (계약내용의 교환)
회사는 보험계약의 체결 및 관리 등을 위한 판단자료로서 활용하기 위하여 다음 각 호의 사항을 계약자 및 피보험자의 동의를 받아 다른 보험회사(보험관련 업무를 위탁받은 자를 포함) 및 보험관련 단체 등에게 제공할 수 있으며 이 경우 회사는 신용정보의이용및보호에관한법률 제23조(개인신용정보의 제공․활용에 대한 동의) 및 동법 시행령 제12조(개인신용정보의 제공․활용에 대한 동의 등)의 규정을 따릅니다.
...
보험설계사 등이 모집과정에서 사용한 회사(각종 점포 및 대리점 포함) 제작의 보험안내장(계약의 청약을 권유하기 위해 만든 서류 등을 말합니다)의 내용이 이 약관의 규정과 다른 경우에는 계약자에게 유리한 내용으로 계약이 성립된 것으로 봅니다.
제29조 (회사의 손해배상책임)
회사는 계약과 관련하여 임직원, 보험설계사 및 대리점의 책임있는 사유로 인하여 발생된 손해에 대하여는 관계법규 및 사업방법서에서 정한 바에 따라 손해배상의 책임을 집니다.
제30조 (예금보험기금에 의한 지급보장)
...
제2조 (보험계약의 무효)
보통약관 제17조(계약의 무효)에서 정한 및 계약을 체결할 때 15세 미만자, 심신상실자 또는 심신박약자를 피보험자로 한 경우에는 이 특별약관은 무효로 합니다.
제3조 (계약연령의 계산)
① 피보험자의 계약연령은 계약일 현재 만 연령으로 계산하고 1년미만의 단수가 있을 때에는 6개월 미만은 버리고 6개월 이상은 1년으로 계산합니다.
...
2-1. 질병의료비 특별약관
제1조 (보상하는 손해)
① 회사는 피보험자가 보통약관 제6조(보상하는 손해)의 여행도중에 질병(다만, 보험계약 청약일로부터 과거 5년이내에 그 질병으로 인하여 진단 또는 치료를 받은 경우에는 제외합니다.)으로 인하여 의사의 치료를 받기 시작했을 때 이 특별약관에 따라 피보험자가 부담하는 의료실비를 보상하여 드립니다. 다만, 의사의 치료를 받기 시작한 날로부터 180일을 한도로 하며, 여행도중에 발생한 질병을 직접원인으로 하여 보험기간 만료후 30일 이내에 의사의 치료를 받기 시작했을 때에도 동일하게 보상하여 드립니다.
...
제2조 (보상하지 아니하는 손해)
회사는 그 원인의 직접 간접을 묻지 아니하고 보통약관 제7조(보상하지 아니하는 손해)의 제1항의 제1호~제3호, 제7호~제11호 및 아래의 사유를 원인으로 하여 생긴 손해는 보상하여 드리지 아니합니다.
...
2-2. 자기부담금설정 추가특별약관
제1조 (보험금의 지급)
회사는 특별약관 제1조(보상하는 손해) 제1항의 규정에도 불구하고 회사가 지급하는 보험금은 1사고마다 피보험자가 실제로 지급한 비용 중 ( )만원을 초과하는 금액으로 합니다.
제2조 (준용규정)
이 추가특별약관에 정하지 아니한 사항은 보통약관 및 특별약관을 따릅니다.
3. 배상책임 특별약관
제1조 (보상하는 손해)
회사는 피보험자가 보통약관 제6조(보상하는 손해)의 여행도중에 생긴 우연한 사고(이하「사고」라 합니다)로 타인의 신체의 장해(이 특별약관에 있어서는 상해, 질병, 사망, 후유장해를 말합니다) 또는 재물의 손해(재물의 없어짐, 손상 및 망가짐을 포함합니다)에 대한 법률적인 배상책임을 부담함으로써 입은 아래의 손해를 이 특별약관에 따라 보상하여 드립니다.
...
제2조 (보상하지 아니하는 손해)
회사는 보통약관 제7조(보상하지 아니하는 손해) 제1항 제1호, 제8호~제11호 및 아래의 사유로 손해배상책임을 부담하게 됨으로써 입은 손해는 보상하여 드리지 아니합니다.
...
제3조 (보험금 등의 지급한도)
① 회사가 보상하는 손해배상금은 보험가입증서(보험증권)에 기재된 보상한도액을 한도로 합니다.
...
① 피보험자가 피해자에게 손해배상책임을 지는 사고가 생긴 때에는 피해자는 이 특별약관에 의하여 회사가 피보험자에게 지급책임을 지는 금액한도내에서 회사에 대하여 보험금의 지급을 직접 청구할 수 있습니다. 그러나 회사는 피보험자가 그 사고에 관하여 가지는 항변으로써 피해자에게 대항할 수 있습니다.
...
제10조 (대위권)
① 회사가 보험금을 지급한 때에는 회사는 지급한 보험금의 한도내에서 아래의 권리를 가집니다. 다만, 회사가 보상한 금액이 피보험자가 입은 손해의 일부인 경우에는 피보험자의 권리를 침해하지 아니하는 범위내에서 그 권리를 가집니다.
...
제2조 (보상하는 손해)
회사는 피보험자가 보통약관 제6조(보상하는 손해)의 여행도중에 생긴 우연한 사고에 의하여 보험의 목적에 입은 손해를 이 특별약관에 따라 보상해 드립니다.
제3조 (보상하지 아니하는 손해)
회사는 보통약관 제7조(보상하지 아니하는 손해) 제1항 제8호~제11호 및 아래의 사유로 인하여 생긴 손해는 보상하여 드리지 아니합니다.
...
제6조 (지급보험금의 계산)
① 회사가 지급할 보험금은 손해액에서 1회의 사고에 대하여 보험가입증서(보험증권)에 기재된 자기부담금을 공제한 금액으로 합니다.
...
제9조 (용어의 대체)
보통약관 제19조(손해의 통지)에서의 사고는 손해로 대체됩니다.
제10조 (준용규정)
이 특별약관에 정하지 아니한 사항은 보통약관을 따릅니다.
5. 특별비용 특별약관
제1조 (보상하는 손해)
...
제3조 (보상하지 아니하는 손해)
회사는 보통약관 제7조(보상하지 아니하는 손해) 제1항 제1호~제3호, 제7호~제11호의 사유로 인하여 생긴 손해는 보상하여 드리지 아니합니다.
제4조 (보험금의 지급)
회사는 제2조(비용의 범위)의 비용 중 정당하다고 인정된 부분에 대해서만 보상하여 드리며, 계약자, 피보험자 또는 보험수익자가 타인으로부터 손해배상을 받을 수 있는 경우에는 그 금액을 지급하지 아니합니다.
제5조 (보험금의 분담)
제1조(보상하는 손해)의 비용에 대하여 보험금을 지급할 다수의 계약이 체결되어 있는 경우에는 각각의 계약에 대하여 다른 계약이 없는 것으로 하여 산출한 보상책임액의 합계액이 그 비용을 초과했을 때 회사는 이 계약에 따른 보상책임액의 위의 합계액에 대한 비율에 따라 보험금을 지급하여 드립니다.
제6조 (보상한도액)
...
6. 천재 상해위험 특별약관
제1조 (보상하는 손해)
회사는 피보험자가 보통약관 제7조(보상하지 아니하는 손해) 제1항 제8호에도 불구하고 지진, 분화 또는 해일로 보통약관 제6조(보상하는 손해)에 정한 상해를 입었을 때에는 그 상해로 인하여 생긴 손해를 이 특별약관에 따라 보상하여 드립니다.
제2조 (준용규정)
이 특별약관에 정하지 아니한 사항은 보통약관을 따릅니다.
7. 사망․후유장해보험금만의 지급특별약관
제1조 (보상하는 손해)
① 회사는 이 특별약관에 따라 보통약관에 규정한 사망․후유장해 보험금만을 지급하여 드립니다. 이 경우 회사는 이 특별약관에 따라 의료비보험금은 지급하지 아니합니다. ② 이 특별약관은 질병의료비 특별약관과 동시에 붙일 수 없습니다.
제2조 (준용규정)
이 특별약관에 정하지 아니한 사항은 보통약관을 따릅니다.
8. 외교관 특별약관
제1조 (피보험자의 범위)
이 특별약관은 보통약관의 피보험자로 하는 경우에 적용합니다.
1. 대한민국 외교관 신분으로 외국에 파견 또는 주재하는 자
2. 제1호의 배우자
3. 제1호의 직계 자녀로서 만19세까지의 자녀
제2조 (보험가입금액)
각 피보험자에 대한 보험가입금액은 다음과 같습니다.
피보험자 사망․후유장해($) 의료비($)
본 인 300,000 1,000
배 우 자 200,000 1,000
자녀1인당 10,000 1,000
제3조 (보상하는 손해)
① 회사는 제1조(피보험자의 범위)의 피보험자가 보험가입증서(보험증권)에 기재된 외국에 파견 또는 주재할 목적으로 현지로 출발하기 위하여 국내의 공항이나 부두에서 비행기 또는 선박에 탑승한 때로부터 귀국하여 비행기나 선박에서 내릴 때까지의 기간동안에 급격하고도 우연한 외래의 사고(이하「사고」라 합니다)로 신체에 상해를 입었을 때에는 그 상해로 인하여 생긴 손해를 이 특별약관에 따라 보상하여 드립니다.
...
제4조 (회사의 보장의 시기 및 종기)
보통약관 제4조(회사의 보장의 시기 및 종기) 제3항에서의 주거지를 출발하기 전과 주거지에 도착한 이후의 발생한 사고는 이 특별약관에서 국내의 공항이나 부두에서 비행기나 선박에 탑승하기 이전과 귀국(일시 귀국인 경우를 포함합니다)하여 비행기나 선박에서 내린 이후의 국내에 있는 기간 동안에 발생한 사고로 변경됩니다.
제5조 (피보험자의 변경)
...
제6조 (보험료의 추징․환급)
① 제3조(보상하는 손해) 제2항 및 제5조(피보험자의 변경) 제1항의 경우에 회사는 해당 피보험자의 경과하지 아니한 기간에 대한 보험료를 일단위로 계산하여 계약자에게 돌려 드립니다.
② 제5조(피보험자의 변경) 제2항의 경우에 보험계약자는 해당 피보험자의 남은 보험기간에 대한 보험료를 납입하여야 합니다.
제7조 (준용규정)
이 특별약관에 정하지 아니한 사항은 보통약관을 따릅니다.
9. 전쟁위험 특별약관
제1조 (보상하는 손해)
① 회사는 보통약관 제7조(보상하지 아니하는 손해) 제1항 제10호의 규정에도 불구하고 전쟁, 외국의 무력행사, 혁명, 내란, 폭동, 소요, 기타 이들과 유사한 사태로 인하여 피보험자가 상해를 입었을 때는 보통약관의 규정에 의한 사망․후유장해보험금을 이 특별약관에 따라 지급하여 드립니다.
...
10. 해외연수생 질병의료비 특별약관
제1조 (피보험자의 범위)
이 특별약관은 피보험자가 다음과 같은 경우 적용합니다.
1. 대학(교) 및 연구소 등에 유학, 연수 및 이와 유사한 연구를 목적으로 하는 자
2. 제1호의 배우자
3. 제1호의 직계자녀로서 만 19세까지의 자녀
제2조 (보상하는 손해)
① 회사는 보통약관 제6조(보상하는 손해)의 여행도중에 질병(다만, 보험계약 청약일로부터 과거 5년이내에 그 질병으로 인하여 진단 또는 치료를 받은 경우에는 제외합니다.)으로 인하여 의사의 치료를 받기 시작했을 때 이 특별약관에 따라 피보험자가 부담하는 의료실비를 보상하여 드립니다. 다만, 의사의 치료를 받기 시작한 날로부터 180일이내의 치료에 소요된 비용을 한도로 하며, 여행도중에 발생한 질병을 직접원인으로 하여 보험기간 만료후 30일 이내에 의사의 치료를 받기 시작했을 때에도 동일하게 보상하여 드립니다.
...
제3조 (보상하지 아니하는 손해)
회사는 그 원인의 직접 간접을 묻지 아니하고 보통약관 제7조(보상하지 아니하는 손해) 제1항 제1호~제3호, 제7호~제11호 및 아래의 사유를 원인으로 하여 생긴 손해는 보상하여 드리지 아니합니다.
1. 회사가 보통약관에 따라 보험금을 지급할 상해에 기인하는 질병
2. 임신, 출산, 유산 그러나 질병에 기인하는 경우에는 보상하여 드립니다.
3. 치아보철 등의 치과치료비용. 그러나 질병은 보상하여 드립니다.
제4조 (보상한도)
회사는 이 특별약관 제2조(보상하는 손해) 제1항의 규정에도 불구하고 회사가 지급하는 보험금은 1사고마다 피보험자가 실제로 지급한 비용중 보험가입증서(보험증권)에 기재된 자기부담금 ( )만원을 공제한 금액으로 합니다.
                </textarea></td>
						</tr>
						<tr>
					</div>
			...
			<div>
				<input id="" type="checkbox" /> <input id="check-btn3"
					type="checkbox" /> <label for="check-btn3">개인정보 수집, 이용 동의</label>
				<ul class="menubars3">
					<div>
						<tr>
							<td align=center><textarea name="tos" rows=15 cols=100
...
1. 개인정보의 수집 항목
: 성명(영문포함), 휴대전화번호, 이메일, 생년월일, 성별, 결제기록, 여권정보, 비자정보 등
2. 개인정보 수집 및 이용 목적
가. 콘텐츠 제공, 구매 및 요금결제, 물품 등을 배송(발송), 금융거래 본인인증 및 금융서비스 등의 서비스 제공에 관한 계약 이행 및 요금정산
나. 인구통계학적 분석자료
다. 불만처리 등의 민원처리 및 고지사항 전달 등을 위한 고객관리
3. 개인정보 보유 및 이용기간
아래와 같은 관계법령의 규정에 의하여 정한 기간 동안 보존할 필요가 있는 경우를 제외하고는 개인정보 수집 및 이용목적이 달성된 후 파기합니다.
...
라. 표시•광고에 관한 기록: 6개월
4. 동의거부권
: 개인정보 수집 및 이용 동의를 거부할 권리가 있으며, 미동의 시 여행서비스의 제공이 제한됩니다.
                </textarea></td>
						</tr>
						<tr>
					</div>
			...
			<div>
				<input id="" type="checkbox" /> <input id="check-btn4"
					type="checkbox" /> <label for="check-btn4">고유식별정보 수집, 이용동의</label>
				<ul class="menubars4">
					<div>
						<tr>
							<td align=center><textarea name="tos" rows=15 cols=100
...
3. 고유식별 정보 보유 및 이용기간
: 수집이용 목적 또는 제공받은 목적의 달성시까지
4. 동의거부권
: 고유식별 정보 수집 및 이용 동의를 거부할 권리가 있으며, 미동의 시 여행서비스의 제공이 제한됩니다.
                </textarea></td>
						</tr>
						<tr>
					</div>
		...
		<div style="border: 1px solid green; text-align: center;">
			...
			<button type="button" onclick="requestPay('${c.ctitle}')"
