...
<script>
	...
	function send(f) {
		...
		var detailAddress = f.udetailAddress.value.trim(); // 상세주소
...
<form name="f">
	<table border="1" align="center">
		...
		<tr>
			<th>아이디</th>
			<td><input type="text" name="uid" placeholder="아이디를 입력해 주세요."></td>
			<td><input type="button" value="중복확인" onclick="user_id_check()">
		</tr>
		
		<!-- 비밀번호 input -->
		<tr>
			<th>비밀번호</th>
			<td colspan="2"><input type="password" name="upwd" placeholder="비밀번호를 입력해 주세요."></td>
		</tr>
		<tr>
			<th>비밀번호 확인</th>
			<td colspan="2"><input type="password" name="upwd2" placeholder="비밀번호를 입력해 주세요."></td>
		</tr>
		
		<!-- 이름 input -->
		<tr>
			<th>이름</th>
			<td colspan="2"><input type="text" name="uname" placeholder="이름을 입력해 주세요."></td>
		</tr>
		...
		<tr>
			<th>이메일</th>
			<td colspan="2"><input type="text" name="uemail" placeholder="이메일을 입력해 주세요."></td>
		</tr>
		...
		<tr>
			<td colspan="3" align="center">
				...
				<input type="button" value="돌아가기" onclick="location.href='userLoing_form.do'">
			</td>
		</tr>
	</table>
</form>
